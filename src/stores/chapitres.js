...
const default_chapters = [
  {
    ...
    nom: "Chapitre 1",
    etat: "actif",
    description: "Intro de la campagne alpha.",
    commentaireMj: "MJ: chapitre d'intro.",
    motPasseActivation: "alpha",
    motPasseResolution: "alpha-fin",
    queteIds: [1],
    recompenseObjetsIds: [1],
  ...
  },
  {
    ...
    nom: "Chapitre 2",
    etat: "inactif",
    description: "Suite de la campagne alpha.",
    commentaireMj: "MJ: chapitre suivant.",
    motPasseActivation: "alpha-2",
    motPasseResolution: "alpha-2-fin",
    queteIds: [2],
  ...
  },
  {
    ...
    nom: "Chapitre 1",
    etat: "inactif",
    description: "Intro de la campagne beta.",
    commentaireMj: "MJ: debut beta.",
    motPasseActivation: "beta",
    motPasseResolution: "beta-fin",
    queteIds: [3],
    recompenseObjetsIds: [],
    recompenseIndicesIds: [2],
    objetsRequisIds: []
  }
];
